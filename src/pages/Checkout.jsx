...
function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Process the order with shipping details only
      const orderData = {
        shippingDetails: {
          ...
          <div className="lg:col-span-2">
            {!isAuthenticated ? (
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl">
                <h2 className="text-2xl font-bold text-white mb-4">Complete Your Purchase</h2>
                <p className="text-gray-300 mb-6">Create an account or sign in to save your shipping details and track your orders.</p>
                <div className="flex gap-4">
                  <button
                    onClick={() => navigate('/login')}
                    className="flex-1 bg-red-600 text-white p-4 rounded-xl hover:bg-red-700 transition-colors"
                  >
                    Login
                  </button>
                  <button
                    onClick={() => navigate('/register')}
                    className="flex-1 bg-gray-700 text-white p-4 rounded-xl hover:bg-gray-600 transition-colors"
                  >
                    Create Account
                  </button>
                </div>
                <div className="mt-6">
                  <button
                    ...
                    className="w-full bg-gray-600 text-white p-4 rounded-xl hover:bg-gray-500 transition-colors"
                  >
                    Continue as Guest
                  </button>
                </div>
